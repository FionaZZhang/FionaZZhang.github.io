  ...
  return (
    <div className="experiences-container">
      ...
      <div className="experience-item">
        ...
        <p className="company">Mighty Games Group</p>
      ...
      <div className="experience-item">
        ...
        <p className="company">Commonwealth Scientific and Industrial Research Organisation (CSIRO)</p>
        <p className="location">Melbourne, Australia</p>
        <ul>
      ...
      <div className="experience-item">
        ...
        <p className="company">The University of Melbourne</p>
        <p className="location">Melbourne, Australia</p>
        <ul>
